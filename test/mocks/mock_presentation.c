// Stubs für alle presentation-Funktionen, die von logic.c benötigt werden
...
void presentation_get_full_name(char *a, int b) {}
void presentation_get_gamertag(char *a, int b) {}
void presentation_error_gamertag_empty(void) {}
void presentation_get_ssn(char *a, int b) {}
void presentation_error_ssn(void) {}
void presentation_get_email(char *a, int b) {}
void presentation_error_email(void) {}
void presentation_choose_subscription_start(void) {}
void presentation_get_subscription_start(char *a, int b) {}
void presentation_choose_subscription_model(void) {}
void presentation_get_subscription_duration(char *a, int b) {}
...
void presentation_display_users_formatted(void) {}
void presentation_display_error(const char *msg) {}
void presentation_get_game_title(char *a, int b) {}
void presentation_get_game_description(char *a, int b) {}
void presentation_get_game_version(char *a, int b) {}
void presentation_get_game_mode(char *a, int b) {}
void presentation_show_message(const char *msg) {}
int presentation_get_game_menu_choice(void) { return 0; }
int presentation_get_game_id_to_edit(void) { return 0; }
